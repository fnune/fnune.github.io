...
module Jekyll
  ...
  class SitemapGenerator < Generator
    ...
    EXCLUDE = %w[/atom.xml /feed.xml /feed/index.xml]
    INCLUDE_POSTS = %w[/index.html]
    ...
    def generate(site)
      ...
      @config['change_frequency_name'] =
        sitemap_config['change_frequency_name'] || CHANGE_FREQUENCY_NAME
